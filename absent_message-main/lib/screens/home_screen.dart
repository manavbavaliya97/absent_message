            ...
            GridView.count(
              ...
              children: [
                ...
                _buildGridItem(
                  ...
                  Icons.domain,
                  Colors.orange,
                  destination: const DepartmentSetupScreen(),
                ),
                _buildGridItem(
                  context,
                  "2. Students",
                  Icons.group_add,
                  Colors.orange,
                  destination: const StudentInputScreen(),
                ),
                _buildGridItem(
                  context,
                  "3. Time Table",
                ...
                _buildGridItem(
                  ...
                  Icons.how_to_reg,
                  Colors.blue,
                  destination: const ManageEnrollmentScreen(),
                ),
                _buildGridItem(
                  context,
                  "Student Reg.",
                  Icons.list_alt,
                  Colors.blue,
                  destination: const DataViewScreen(),
                ),
                _buildGridItem(
                  context,
                  "View Logs",
                  Icons.history_edu,
                  Colors.blue,
                  destination: const AttendanceLogScreen(),
                ),
                ...
                _buildGridItem(
                  ...
                  Icons.share,
                  Colors.brown,
                  destination: const CustomReportScreen(),
                ),
                _buildGridItem(
                  context,
                  "Backup DB",
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const ReportGeneratorScreenV3(),
          ),
        ),
